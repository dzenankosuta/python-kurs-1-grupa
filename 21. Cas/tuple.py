# Tuple je kolekcija koja je uredjena (ordered) i nepromenljiva (unchengeable).
...
# tuple prevedemo u listu (koja dozvoljava menjanje elemenata) i nakon promene vratiti listu u tuple.
...
# Kada se radi o dodavanje elemenata u tuple, to takodje nije dozvoljeno. Medjutim to se moze izvrsiti
# opet na nacin da se tuple prevede u listu i nakon dodavanja elemenata listi, opet je vratiti u tuple.
...
# tuple_a u listu i nakon toga izbrisati odredjeni element, te vratiti u tuple.
