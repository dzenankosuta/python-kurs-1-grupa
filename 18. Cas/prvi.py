#  extend() metoda nam omogucava spajanje dve liste
...
# extend() metoda pored liste moze dodati i tuples,set,dictionaries...
...
izbrisana_stavka = voce.pop()  # mozemo sacuvati kao promenljivu izbrsanu stavku iz liste
print(voce)
...
# Napraviti listu od elemenata 1-10, na nacin kakav smo radili u prethodnom primeru
...
# Napraviti novu listu sacinjenu od elemenata lista5, samo u slucaju "banana" ispisati "narandza"
...
# Domaci:
# napraviti dve liste po svojoj zelji, neka imaju po 5 elemenata.
# dodati drugu listu prvoj,
# isbrisati prvi i poslednji element prosirene liste,
