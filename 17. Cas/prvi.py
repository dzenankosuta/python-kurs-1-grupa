...
# Liste su promenjlive. Mozemo izmeniti odredjeni element liste pristupanjem njemu preko indeksa.
# Svakako mozemo izmeniti vise elemenata odjednom. Takodje nam je dozvoljeno da ovakvim izmenama
# prosirimo nasu listu. Sve spomenuto je odradjeno u primerima iznad.
...
# Domaci:
lista1 = ["Mercedes", "Audi", "Fiat", "Porshe", "Passat"]
