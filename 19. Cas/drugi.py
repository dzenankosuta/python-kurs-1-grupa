...
# copy() metoda sluzi za pravljenje nove liste, sacinjene od 
# elemenata stare liste

voce2 = voce.copy()
print(voce2)

# Mozemo jednostavno reci da je neka promenljiva, npr. voce3=voce
# Medjutim to nije dobra praksa iz razloga sto bilo kakva promena unutar bilo koje od te dve 
# liste ce se odraziti na onu drugu. 
