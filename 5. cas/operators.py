...
x= 10
print(x)
x+=3  # x je imalo vrednost 10. Nakon toga smo dodali 3. (x+=3) I sada x iznosi 13  
print(x)
...
#  Domaci. Odraditi po jedan primer za svaki predjeni operator danas. 
# 7 aritmetickih, 8 operatora dodele vrednosti, 6 operatora poredjenja i 3 logicka operatora.


#   5.  Identicki operatori

#  Koriste se za uporedjivanje objekata. 
#  Ne ako su jednaki, vec ako su zapravo isti objekat, sa istom memorijskom lokacijom.
...
#  Koriste se za ispitivanje da li je odredjeni niz prisutan u nekom objektu.
